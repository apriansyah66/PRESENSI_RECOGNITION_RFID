...
<div id="layoutSidenav_content">
    ...
    FROM rekap";
                ...
                // Get total employees
                $sql_mahasiswa = "SELECT COUNT(*) as total_mahasiswa FROM mahasiswa";
                $result_mahasiswa = $koneksi->query($sql_mahasiswa);
                $total_mahasiswa = $result_mahasiswa ? $result_mahasiswa->fetch_assoc()['total_mahasiswa'] : 0;
                ?>
